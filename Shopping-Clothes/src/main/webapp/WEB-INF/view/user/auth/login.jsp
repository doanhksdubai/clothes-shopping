        ...
        <div class="form-container">
            ...
            <form method="post" action="/login">
                <c:if test="${param.error != null}">
                    <div class="my-2" style="color: red;">Thông tin email hoặc mật khẩu không chính xác.</div>
              </c:if>
              <c:if test="${param.logout != null}">
                <div class="my-2" style="color: rgb(0, 255, 94);">Bạn đã đăng xuất thành công.</div>
          </c:if>
                <!-- Email -->
                <div class="mb-3">
